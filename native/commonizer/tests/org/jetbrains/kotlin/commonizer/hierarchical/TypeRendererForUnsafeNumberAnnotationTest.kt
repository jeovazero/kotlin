...
import org.jetbrains.kotlin.commonizer.core.CirTypeRendererForUnsafeNumberAnnotation
import org.jetbrains.kotlin.types.Variance
import org.junit.Test
import kotlin.test.assertEquals

class TypeRendererForUnsafeNumberAnnotationTest {
    @Test
    fun `test simple class type with no arguments`() {
        ...
        assertEquals("kotlin.String", CirTypeRendererForUnsafeNumberAnnotation.renderType(type))
    }
    ...
    fun `test class type with arguments`() {
        ...
        assertEquals("kotlin.Triple<kotlin.String, out kotlin.Number, *>", CirTypeRendererForUnsafeNumberAnnotation.renderType(type))
    }
    ...
    fun `test flexible type`() {
        ...
        assertEquals("kotlin.String..kotlin.String?", CirTypeRendererForUnsafeNumberAnnotation.renderType(type))
    }
    ...
    fun `test flexible type argument`() {
        ...
        assertEquals("kotlin.Array<out kotlin.String..kotlin.String?>", CirTypeRendererForUnsafeNumberAnnotation.renderType(type))
    }
    ...
    fun `test nested type argument`() {
        ...
        assertEquals("kotlin.Array<out kotlin.Array<in kotlin.String>>", CirTypeRendererForUnsafeNumberAnnotation.renderType(type))
    }
    ...
    fun `test type parameter type in type argument`() {
        ...
        assertEquals("kotlin.Array<#0?>", CirTypeRendererForUnsafeNumberAnnotation.renderType(type))
    }
    ...
    fun `test combined type`() {
        ...
        assertEquals(
            ...
            CirTypeRendererForUnsafeNumberAnnotation.renderType(type)
        )
    }
}
