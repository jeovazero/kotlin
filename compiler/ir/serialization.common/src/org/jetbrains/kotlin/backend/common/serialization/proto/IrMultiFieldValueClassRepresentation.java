...
public final class IrMultiFieldValueClassRepresentation extends
  ...
  public void writeTo(org.jetbrains.kotlin.protobuf.CodedOutputStream output)
    ...
    for (int i = 0; i < underlyingPropertyName_.size(); i++) {
      output.writeInt32(1, underlyingPropertyName_.get(i));
    }
    for (int i = 0; i < underlyingPropertyType_.size(); i++) {
      output.writeInt32(2, underlyingPropertyType_.get(i));
    }
  ...
  public int getSerializedSize() {
    ...
    size = 0;
    {
      ...
      size += dataSize;
      size += 1 * getUnderlyingPropertyNameList().size();
    }
    {
      int dataSize = 0;
      for (int i = 0; i < underlyingPropertyType_.size(); i++) {
      ...
      size += dataSize;
      size += 1 * getUnderlyingPropertyTypeList().size();
    }
